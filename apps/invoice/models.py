"""Database models for invoice extraction jobs."""
...
class InvoiceJob(models.Model):
    """Tracks a single invoice document extraction request and its outcome."""
    ...
    def __str__(self) -> str:
        ...
        return f"InvoiceJob({self.pk}, {self.status}, {self.document_type})"
