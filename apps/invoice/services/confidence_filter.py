"""Confidence-based splitting of extracted invoice fields."""
...
from apps.invoice.services.field_mapper import MappedField, MappedFields
...
def get_confidence_threshold() -> float:
    """Read the invoice confidence threshold from Django settings."""
    return float(getattr(settings, "INVOICE_CONFIDENCE_THRESHOLD", 0.75))
