"""OCR API views for the deals feature."""
...
def extract_deal_document(request) -> Response:
    """Extract deal_create CRM fields from an uploaded document via Azure OCR."""
    ...
    if target_schema != "deal_create":
        return Response(
            {"target_schema": ["Only deal_create is supported on this endpoint."]},
    ...
    try:
        ...
        ocr_result, extracted_fields, needs_review_fields, confidence_scores = (
            extract_deal_document_from_upload(
                uploaded_file,
                document_type=document_type,
                target_schema=target_schema,
            )
