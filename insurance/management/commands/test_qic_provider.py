...
class Command(BaseCommand):
    help = "Test QIC provider authentication, health check, and optional quote flow."
    ...
    def handle(self, *args, **options):
        try:
            queryset = InsuranceProvider.objects.filter(code__iexact="QIC")
        ...
        if provider_config is None:
            raise CommandError("No QIC provider configuration found.")
